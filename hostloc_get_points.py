...
def login(username, password):
    ...
    login_url = "https://www.right.com.cn/forum/member.php?mod=logging&action=login&loginsubmit=yes&frommessage&loginhash=Ly6GZ&inajax=1"
    login_data = {
...
def check_login_status(s, number_c):
    test_url = "https://www.right.com.cn/forum/home.php?mod=spacecp&ac=profile"
    res = s.get(test_url)
    res.encoding = "utf-8"
